...
经过对[《重学安卓》](https://xiaozhuanlan.com/kunminx)专栏近 1 年的学习和思维演练，相信小伙伴们多已演化成为 “深度思考的老司机”，面对 Jetpack MVVM 架构组件的高频场景 多能瞬间做到 “以不变应万变”、“一句话讲到点上”。
...
> Request、UseCase 等组件位于领域层，提供可复用的转发；
