...
package com.kunminx.livedata.event;
...
abstract class ELiveData<T> {
    ...
    void dispatchingValue(@Nullable ObserverWrapper initiator) {
        ...
        do {
            ...
            if (initiator != null) {
                ...
                for (@SuppressLint("RestrictedApi") Iterator<Map.Entry<EventObserver<T>, ObserverWrapper>> iterator =
    ...
    public void observe(@NonNull LifecycleOwner owner, @NonNull EventObserver<T> eventObserver) {
        ...
        @SuppressLint("RestrictedApi") ObserverWrapper existing = mObservers.putIfAbsent(eventObserver, wrapper);
    ...
    public void removeObserver(@NonNull final EventObserver<T> eventObserver) {
        ...
        @SuppressLint("RestrictedApi") ObserverWrapper removed = mObservers.remove(eventObserver);
        if (removed == null) {
            return;
        }
     ...
     * thread, you can use {@link ELiveData#postValue(Event)} (Object)}
     *
     * @param value The new value
     */
    @MainThread
