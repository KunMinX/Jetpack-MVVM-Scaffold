...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSharedViewModel.activityCanBeClosedDirectly.observeActivity(this, aBoolean -> {
        ...
        mSharedViewModel.openOrCloseDrawer.observeActivity(this, aBoolean -> {
        ...
        SharedViewModel.ENABLE_SWIPE_DRAWER.observeActivity(this, aBoolean -> {
