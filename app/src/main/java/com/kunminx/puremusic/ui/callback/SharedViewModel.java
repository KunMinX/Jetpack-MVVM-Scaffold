...
public class SharedViewModel extends ViewModel {
    ...
    // TODO tip 1：此处演示通过 UnPeekLiveData<Event<Object>> 配合 SharedViewModel 来发送 生命周期安全的、事件源可追溯的 通知。
    ...
    public static final UnPeekLiveData<Boolean> ENABLE_SWIPE_DRAWER = new UnPeekLiveData<>();
